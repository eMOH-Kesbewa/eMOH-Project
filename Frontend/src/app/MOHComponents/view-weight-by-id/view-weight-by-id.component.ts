...
export class ViewWeightByIdComponent implements OnInit {
  ...
  constructor(private weightService: WeightService, private router: Router, private activeroute: ActivatedRoute, private formBuilder: FormBuilder, private _snackBar: MatSnackBar) { }
  ...
  ngOnInit() {
    ...
    this.weightService.getbabyweightdata(this.babyId).subscribe(data => {
