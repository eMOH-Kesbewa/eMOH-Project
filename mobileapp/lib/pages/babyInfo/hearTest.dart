                      ...
                      child: Column(
                        children: <Widget>[
                          Chip(
                            ...
                            label: Text(AppLocalizations.of(context).tr('afterfewmonthsofbirth')),
                          ),
                          SizedBox(
                            height: 0.0,
                          ),
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('afterfewmonthsofbirthtxt')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Chip(
                            ...
                            label: Text(AppLocalizations.of(context).tr('inonemonth')),
                          ),
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('inonemonthtxt')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Chip(
                            ...
                            label: Text(AppLocalizations.of(context).tr('fromthefourmonths')),
                          ),
                          Card(
                              child: ListTile(
                            title: Text(
                                AppLocalizations.of(context).tr('fromthefourmonthstxt1')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('fromthefourmonthstxt2')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Chip(
                            ...
                            label: Text(AppLocalizations.of(context).tr('fromthesevenmonths')),
                          ),
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('fromthesevenmonthstxt1')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Chip(
                            ...
                            label: Text(AppLocalizations.of(context).tr('inninemonths')),
                          ),
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('inninemonthstxt1')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('inninemonthstxt2')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('inninemonthstxt3')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Chip(
                            ...
                            label: Text(AppLocalizations.of(context).tr('intwelvemonths')),
                          ),
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('intwelvemonthstxt1')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Card(
                              child: ListTile(
                            title: Text(AppLocalizations.of(context).tr('intwelvemonthstxt2')),
                            trailing: Checkbox(
                                activeColor: Colors.red,
                          ...
                          Text(AppLocalizations.of(context).tr('specialnote'),
