  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Baby>(
      ...
      builder: (context, snapshot) {
        logger.i('layingFaceDownVis');
        print(snapshot.data.bigSoundCon);
        ...
        List<Choice> choices = <Choice>[
          Choice(
              ...
              GrowthCard(
                  ...
                  layingFaceDownVis,'lie_your_hips_and_head_up_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  movingObjectVis,'something_keeps_moving_from_one_place_to_another_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  bigSoundVis,'stopping_or_increasing_action_responds_to_a_sudden_loud_noise_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  ohhVis,'sounds_like_a_e_in_response_to_stimulus_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  smileVis,'the_mother_recognize_and_smiles_age_at_the_time_of_occurence'),
              5),
          Choice.six(
              '02',
              Icons.book,
              ...
              GrowthCard(
                  ...
                  playFingersVis,'they_play_when_crossing_fingers_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  strechHandVis,'streching_his_hands_toward_something_he_hold_it_with_his_whole_hand_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  soundTurnVis,'when_heard_a_sound_he_turn_his_head_toward_that_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  singleLetterSoundVis,'emits_single_letter_sounds_age_at_the_time_of_occurence'),
              GrowthCard(
                  'laugh loudly.',
                  snapshot.data.laughtLoudOcc.toString(),
                  snapshot.data.laughtLoudCon.toString(),
                  snapshot.data.laughtLoudOf.toString(),
                  laughtLoudVis,'smiles_loudely_age_at_the_time_of_occurence'),
              6),
          Choice.four(
              '03',
              Icons.book,
              ...
              GrowthCard(
                ...
                raiseHead2Vis,'lie_your_hips_and_head_up_age_at_the_time_of_occurence'
              ),
              GrowthCard(
                  ...
                  turnFaceUpDownVis,'turn_back_again_and_again_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  switchObjectVis,'change_something_another_hand_to_other_hand_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  makeSoundVis,'some_sounds_are_repeated_age_at_the_time_of_occurence'),
              4),
          Choice.six(
              '04',
              Icons.book,
              ...
              GrowthCard(
                ...
                sittingVis,'siting_without_help_age_at_the_time_of_occurence'
              ),
              GrowthCard(
                  ...
                  holdingHimSelfVis,'holding_himself_alone_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  thumbForeVis,'holding_small_things_using_thumb_And_forefinger_age_at_the_time_of_occurence'),
              GrowthCard(
                  'Imitate sounds.',
                  snapshot.data.followingVoiceOcc.toString(),
                  snapshot.data.followingVoiceCon.toString(),
                  snapshot.data.followingVoiceOf.toString(),
                  followingVoiceVis,'following_voice_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  proWordsVis,'pronounce_individual_words_makes_sounds_that_make_sense_age_at_the_time_of_occurence'),
              GrowthCard(
                  'Understand simple instructions.',
                  snapshot.data.understandOcc.toString(),
                  snapshot.data.understandCon.toString(),
                  snapshot.data.understandOf.toString(),
                  understandVis,'understand_simple_instructions_age_at_the_time_of_occurence'),
              6),
              Choice(
              '05',
              Icons.book,
              ...
              GrowthCard(
                  ...
                  walkingWithHelpVis,'walking_with_help_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  canSpeakVis,'they_can_speak_At_least_two_or_three_words_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  handPointVis,'hand_is_pointed_out_when_hearing_familiar_things_age_at_the_time_of_occurence'),
              GrowthCard(
                  'Can roll a small ball.',
                  snapshot.data.canRollOcc.toString(),
                  snapshot.data.canRollCon.toString(),
                  snapshot.data.canRollOf.toString(),
                  canRollVis,'they_can_roll_a_boll_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  canIdentifyVis,'can_identify_at_least_one_body_part_age_at_the_time_of_occurence'),
              5),
              Choice.six(
              '06',
              Icons.book,
              ...
              GrowthCard(
                ...
                snapshot.data.walkingWithHelpCon.toString(),
                snapshot.data.walkingWithHelpOf.toString(),
                walkingWithoutHelpVis,'walking_without_help_age_at_the_time_of_occurence'
              ),
              GrowthCard(
                  ...
                  canClimbVis,'can_climb_the_stair_with_help_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  makeTowerVis,'can_make_a_tower_using_building_blocks_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  eatHimselfVis,'eat_himself_alone_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  canTalkTenVis,'can_talk_about_ten_words_can_talk_at_least_one_sentence_with_two_words_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  lipsShapeVis,'the_lips_are_sharpened_to_kiss_age_at_the_time_of_occurence'),
              6),
              Choice.four(
              '07',
              Icons.book,
              ...
              GrowthCard(
                ...
                runWithoutFallingVis,'ability_to_run_without_falling_age_at_the_time_of_occurence'
              ),
              GrowthCard(
                  ...
                  upDownStairVis,'ability_to_down_and_up_stair_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  canCopyVis,'can_copy_an_art_with_a_circle_age_at_the_time_of_occurence'),
              GrowthCard(
                  ...
                  canCreateVis,'can_create_a_sentence_with_three_or_more_words_age_at_the_time_of_occurence'),
              4),
        ];
