...
class Baby {
  ...
  factory Baby.fromJson(Map<String, dynamic> json) {
    return Baby(
        ...
        smileOf:
            json['the_mother_recognize_and_smiles_status_of_the_officer'],
        ...
        playFingersCon: json['they_play_when_crossing_fingers_age_at_the_confirmed'],
        playFingersOf: json['they_play_when_crossing_fingers_status_of_the_officer'],

        strechHandOcc: json['streching_his_hands_toward_something_he_hold_it_with_his_whole_hand_age_at_the_time_of_occurence'],
        strechHandCon: json['streching_his_hands_toward_something_he_hold_it_with_his_whole_hand_age_at_the_confirmed'],
        strechHandOf: json['streching_his_hands_toward_something_he_hold_it_with_his_whole_hand_status_of_the_officer'],
        soundTurnOcc: json['when_heard_a_sound_he_turn_his_head_toward_that_age_at_the_time_of_occurence'],
        soundTurnCon: json['when_heard_a_sound_he_turn_his_head_toward_that_age_at_the_confirmed'],
        soundTurnOf: json['when_heard_a_sound_he_turn_his_head_toward_that_status_of_the_officer'],
        singleLetterSoundOcc: json['emits_single_letter_sounds_age_at_the_time_of_occurence'],
        singleLetterSoundCon: json['emits_single_letter_sounds_age_at_the_confirmed'],
        singleLetterSoundOf: json['emits_single_letter_sounds_status_of_the_officer'],
        ...
        switchObjectCon: json['change_something_another_hand_to_other_hand_age_at_the_confirmed'],
        switchObjectOf: json['change_something_another_hand_to_other_hand_status_of_the_officer'],
        ...
        thumbForeCon: json['holding_small_things_using_thumb_And_forefinger_age_at_the_confirmed'],
        thumbForeOf: json['holding_small_things_using_thumb_And_forefinger_status_of_the_officer'],
        ...
        proWordsCon: json['pronounce_individual_words_makes_sounds_that_make_sense_age_at_the_confirmed'],
        proWordsOf: json['pronounce_individual_words_makes_sounds_that_make_sense_status_of_the_officer'],
        understandOcc: json['understand_simple_instructions_age_at_the_time_of_occurence'],
        understandCon: json['understand_simple_instructions_age_at_the_confirmed'],
        understandOf: json['understand_simple_instructions_status_of_the_officer'],
        ...
        canSpeakCon: json['they_can_speak_At_least_two_or_three_words_age_at_the_confirmed'],
        canSpeakOf: json['they_can_speak_At_least_two_or_three_words_status_of_the_officer'],
        handPointOcc: json['hand_is_pointed_out_when_hearing_familiar_things_age_at_the_time_of_occurence'],
        handPointCon: json['hand_is_pointed_out_when_hearing_familiar_things_age_at_the_confirmed'],
        handPointOf: json['hand_is_pointed_out_when_hearing_familiar_things_status_of_the_officer'],
        ...
        canIdentifyCon: json['can_identify_at_least_one_body_part_age_at_the_confirmed'],
        canIdentifyOf: json['can_identify_at_least_one_body_part_status_of_the_officer'],
        ...
        makeTowerCon: json['can_make_a_tower_using_building_blocks_age_at_the_confirmed'],
        makeTowerOf: json['can_make_a_tower_using_building_blocks_status_of_the_officer'],
        ...
        canTalkTenCon: json['can_talk_about_ten_words_can_talk_at_least_one_sentence_with_two_words_age_at_the_confirmed'],
        canTalkTenOf: json['can_talk_about_ten_words_can_talk_at_least_one_sentence_with_two_words_status_of_the_officer'],
        ...
        runWithoutFallingCon: json['ability_to_run_without_falling_age_at_the_confirmed'],
        runWithoutFallingOf: json['ability_to_run_without_falling_status_of_the_officer'],
        ...
        canCreateCon: json['can_create_a_sentence_with_three_or_more_words_age_at_the_confirmed'],
        canCreateOf: json['can_create_a_sentence_with_three_or_more_words_status_of_the_officer'],
